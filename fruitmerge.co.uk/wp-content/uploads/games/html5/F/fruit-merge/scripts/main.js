...
// Construct export runtime bootstrap.
...
// scripts/plugins/advert/dom/disabled.js
("use strict");
{
  const COMPONENT_ID = "advert",
    STATUS = "NOT_REQUIRED&&disabled&&false",
    ...
    METHODS = [
      ...
      "CreateVideoAdvert",
      "ShowVideoAdvert",
      "CreateRewardedAdvert",
      "ShowRewardedAdvert",
      "CreateRewardedInterstitialAdvert",
      "ShowRewardedInterstitialAdvert",
      "Configure",
      "RequestConsent",
      "SetUserPersonalisation",
  ...
  class DisabledAdvertDOMHandler extends self.DOMHandler {
    constructor(runtimeInterface) {
      super(runtimeInterface, COMPONENT_ID);
      const handler = (method) => [method, () => this._CallMethod(method)];
      this.AddRuntimeMessageHandlers([
        ...METHODS.map(handler),
        ["AddScript", () => this._AddScript()],
      ]);
    }
    ...
    _CallMethod(method) {
      switch (method) {
        ...
        case "ShowRewardedAdvert":
        case "ShowRewardedInterstitialAdvert":
          return REWARD;
        default:
          return "ads disabled";
      }
  ...
  self.RuntimeInterface.AddDOMHandlerClass(DisabledAdvertDOMHandler);
}
    ...
    async _GetSafeAreaInset() {
      ...
      if (!e) {
        ...
        const s = getComputedStyle(e),
          r = [
            s.getPropertyValue("--temp-sai-top"),
            s.getPropertyValue("--temp-sai-right"),
            s.getPropertyValue("--temp-sai-bottom"),
            s.getPropertyValue("--temp-sai-left"),
          ].map((e) => {
